...
The only really-needed code is located in the **[src](src)** folder. Inside of it, the folder "route_1" and all of its content can also be deleted since it is just an example.